...
//
// Purpose: This test simulates a complete user flow  on an e-commerce site.
//
// Steps:
...
// 5. Verify cart ciontents 
// 6. Attempt checkout (disabled since feature isn't awailable on demo site);
...
test("Execute end-to-end test flow @end-to-end", async ({page}) => {
    ...
    console.log("✅ Shoping cart verification completed!");
...
async function addProductToCart(page: Page) {
    ...
    // Confirm product was added (wait for element visibility handled inside the page object)
